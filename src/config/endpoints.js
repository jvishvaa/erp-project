...
export default {
  ...
  teacherDashboard: {
    ...
    pendingCWdata: `${msReportsUrl}/api/acad_performance/v1/teacher-dashboard/pending-cw/`,
    submittedCWdata: `${msReportsUrl}/api/acad_performance/v1/teacher-dashboard/pending-cw-students/`,
