...
export default {
  ...
  ownerDashboard: {
    ...
    chapterWise : `${msReportsUrl}/api/acad_performance/v2/curriculam-chapter-wise-data/`,
    teacherWise : `${msReportsUrl}/api/acad_performance/v2/curriculam-teacher-wise-data/`,
    topicWise : `${msReportsUrl}/api/acad_performance/v2/curriculam-topic-wise-data/`,
