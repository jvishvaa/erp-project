    ...
    return (
        <Editor
            ...
            init={{
                ...
                toolbar: 'fontselect fontsizeselect bold italic alignleft aligncenter alignright underline bullist numlist file image customInsertButton',
                setup: id.startsWith("questionEditor") && function (editor) {
                ...
                file_picker_callback: function (cb, value, meta) {
                    ...
                    input.onchange = function (e) {
                        ...
                        if (file && file[0] && (file[0].name.lastIndexOf(".jpg")>0 || file[0].name.lastIndexOf(".jpeg")>0 || file[0].name.lastIndexOf(".png") > 0)) {
                            ...
                            axiosInstance.post(`${endpoints.questionBank.uploadFile}`, formData)
                                .then(result => {
