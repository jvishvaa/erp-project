    ...
    <div className={classes.myTinyEditor}>
      <Editor
        ...
        init={{
          ...
          toolbar: `${
            isSocialMediaEditor ? '' : 'fontselect fontsizeselect'
          } bold italic alignleft aligncenter alignright underline bullist numlist file ${
            isSocialMediaEditor ? '' : 'image'
          } customInsertButton`,
          setup:
