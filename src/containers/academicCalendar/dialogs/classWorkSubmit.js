...
function ClassWorkSubmit() {
            ...
            <div style={{ display: 'flex' }}>
              <span>
                <VisibilityIcon
                  ...
                  onClick={() => {
                    const fileSrc = `${endpoints.lessonPlan.s3erp}/homework/${file}`;
                    openPreview({
  ...
  const handleSubmit = async () => {
    let payload = {
      online_class_id: 1088, //To do import online class id as prop
    };
    if (filePath?.length) {
                  ...
                  <SvgIcon
                    component={() => (
                      <VisibilityIcon
                        ...
                        onClick={() => {
                          const fileSrc = `${endpoints.lessonPlan.s3erp}/homework/${value}`;
                          openPreview({
                            currentAttachmentIndex: 0,
                            attachmentsArray: [
                              {
...
export default ClassWorkSubmit;
