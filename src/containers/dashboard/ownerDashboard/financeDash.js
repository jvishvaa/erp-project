...
const FinanceOwnerDashboard = (props) => {
  ...
  useEffect(() => {
    if (props?.branchList?.length > 0) {
      ...
      getStudentReport(props?.branchList[0]?.branch?.id, props?.branchList[0]?.session_year?.id)
                          ...
                          >
                            ...
                            <div className={clsx(classes.cuirularButton)}>
                              <Box sx={{ position: 'relative', display: 'inline-flex' }}>
                                <CircularProgress variant="determinate" value={each?.percentage_present} />
                                <Box
                                  sx={{
                                    top: 0,
                                    left: 0,
                        ...
                        >
                          <div>
                            ...
                            <Typography
                              className={clsx(classes.fontDesign, classes.fontColor3)}
                              variant='body2'>
                              <b>Present : {props?.studentAttendance ? props?.studentAttendance?.total_present : ''}</b>
                            </Typography>
                            <Typography
                              className={clsx(classes.fontDesign, classes.fontColor2)}
                              variant='caption'>
                          ...
                          <div className={clsx(classes.cuirularButton)}>
                            <Box sx={{ position: 'relative', display: 'inline-flex' }}>
                              <CircularProgress variant="determinate" value={props?.studentAttendance?.total_avg} />
                              <Box
                                sx={{
                                  top: 0,
                                  left: 0,
                ...
                <CardContent>
                  ...
                  <Grid container spacing={3} alignItems='center'>
                    <Grid item xs={12}>
                      ...
                      >
                        Total Fee{' '} <b style={{ color: '#628fef', fontWeight: '800', marginLeft: '10px' }}>₹ {props?.financeData ? props?.financeData?.totalfees : ''}</b>
                      </Typography>
                      {/* <Typography
                        // variant='h5'
                        color='primary'
                      ...
                      <Card elevation={0}>
                        <CardContent className={clsx(classes.cardContant)}>
                          <Typography
                            ...
                            className={clsx(classes.textAlignCenter, classes.customTextSize)}
                          >
                            Total Collected
                          </Typography>
                      ...
                      <Card elevation={0}>
                        <CardContent className={clsx(classes.cardContant)}>
                          <Typography
                            ...
                            className={clsx(classes.customTextSize, classes.textAlignCenter)}
                          >
                            Total Pending
                          </Typography>
                          <div className={clsx(classes.lookALikeButton)}>
                            ...
                            >
                              ₹ {props?.financeData ? props?.financeData?.outstanding : ''}
                            </Typography>
                          </div>
                        </CardContent>
                      </Card>
                      ...
                      <Card elevation={0}>
                        <CardContent className={clsx(classes.cardContant)}>
                          ...
                          <div className={clsx(classes.lookALikeButton)}>
                            ...
                            >
                              {props?.financeData ? props?.financeData?.no_of_admission : ''}
                            </Typography>
                          </div>
                        </CardContent>
                      </Card>
                  ...
                  : <Grid style={{minHeight: '180px' , textAlign: 'center' , display: 'flex'}} >
                    <Typography style={{margin: 'auto' , fontWeight: '600'}}>No Data</Typography>
                  </Grid> }
                </CardContent>
              </Card>
              {/* </Grid> */}
            ...
            <Grid item container spacing={2} xs={6}>
              ...
              <Grid item xs={12}>
                <Card>
                  ...
                  />
                  <Divider />
                  <CardContent style={{minHeight: '300px' , display: 'flex' , justifyContent: 'center'}}>
                    {props?.staffOverAll[0] ? 
                    <Grid container spacing={3} alignItems='center' style={{overflowX : 'auto' , maxHeight: '300px'}} >
                      ...
                      {props?.staffOverAll && props?.staffOverAll?.map((item) => (
                        ...
                        <div className={clsx(classes.absentGrid)}>
                          <div style={{ width: '33%' }}>
                            <Typography
                              variant='body2'
                              // className={classes.textAlignCenter}
                              className={clsx(classes.customTextSize, classes.customLeftText)}
                            >
                              {item?.role_name}
                            </Typography>
                          </div>
              ...
              {props?.branchList?.length > 0 &&
                props?.branchList?.map((each, index) => {
                  return (
                    ...
                    >
                      <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls={`${index}-content`} id={`${index}-header`} >
                      ...
                      <AccordionDetails>
                        ...
                        {loading ? <Loading /> : <>
                            ...
                            <Grid item xs={4} onClick={() => handleStudentreport(each)} style={{cursor : 'pointer'}} >
                              <div
                                className={clsx(
                                  classes.detailsDiv,
                                  classes.applyColor2
                            ...
                            <Grid item xs={4} onClick={() => handleAttendance(each)}  style={{cursor : 'pointer'}} >
                              <div
                                className={clsx(
                                  classes.detailsDiv,
                                  classes.applyColor3
