...
const ReportTab = () => {
    ...
    return (
        <Layout>
            <div style={{ width: '100%', overflow: 'hidden', padding: '20px' }} className='whole-report-curr' >
                                                ...
                                                <div className={`acc${index + 1}`} >
                                                    {each ? (
                                                        <Accordion
                                                            ...
                                                            style={{ margin: '10px 0', border: '1px solid', borderRadius: '10px', border: '1px solid #EEEEEE', borderRadius: '7px' }}
                                                        >
                                                            <AccordionSummary expandIcon={<ExpandMoreIcon />} style={{ display: 'flex', justifyContent: 'space-between' }}  >
                                                                <Typography onClick={() => history.push('/curriculum-completion-section')} >{each.grade_name}</Typography>
                                                            </AccordionSummary>
                                                            <AccordionDetails>
                                                                <div style={{ width: '100%', margin: '3%', border: '1px solid #D4D4D4', borderRadius: '7px', padding: '10px', background: '#FAFAFA' }}>
                                                                    ...
                                                                    >
                                                                        <TabPanel value={value} index={0} dir={theme.direction} style={{ display: 'flex', flexDirection: 'column' }} className="tabPaneltest" >
                                                                            <div style={{ display: 'flex', justifyContent: 'space-between', width: '50%', float: 'right' }} >
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }} >T. Students</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }} >St. Below Threshold</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }}>Avg Marks</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }}></Typography>
                                                                            </div>
                                                                            <div className='firstSec' >
                                                                                {alltest && alltest.map((item, index) => (
                                                                                    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', border: '1px solid #EEEEEE', padding: '1% 2%' }}  >
                                                                                        <div>
                                                                                            All Section
                                                                                        </div>
                                                                                        <div style={{ display: 'flex', justifyContent: 'space-between', width: '45%', marginRight: '3%' }} >
                                                                                            <div>
                                                                                                {item?.total_students}
                                                                                            </div>
                                                                                            <div>
                                                                                ...
                                                                                {testSection && testSection.map((item, index) => (
                                                                                    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', border: '1px solid #EEEEEE', padding: '1% 2%' }} onClick={() => handleTestClick(item, each)}  >
                                                                                        <div>
                                                                                            {item?.section_name}
                                                                                        </div>
                                                                                        <div style={{ display: 'flex', justifyContent: 'space-between', width: '45%', marginRight: '3%' }} >
                                                                                            ...
                                                                                            <div>
                                                                                                {item?.assignment_details?.below_threshold}
                                                                                            </div>
                                                                                            <div>
                                                                                                {`${Math.round(item?.assignment_details?.avg_score)}%`}
                                                                                            </div>
                                                                                            <ArrowForwardIcon />
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <TabPanel value={value} index={1} dir={theme.direction} className="tabPaneltest" >
                                                                            <div style={{ display: 'flex', justifyContent: 'space-between', width: '60%', float: 'right' }} >
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }} >T. Students</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }} >St. Below Threshold</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }}>Avg.Marks</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }}></Typography>
                                                                            ...
                                                                            {hwSection?.hw_details && hwSection?.hw_details?.map((item) => (

                                                                                <div className='firstSec' onClick={() => handleHwClick(item, each)} >
                                                                                    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', border: '1px solid #EEEEEE', padding: '1% 2%' }} >
                                                                                        <div>
                                                                                            {item?.section_name}
                                                                                        </div>
                                                                        ...
                                                                        <TabPanel value={value} index={2} dir={theme.direction} className="tabPaneltest" >
                                                                            <div style={{ display: 'flex', justifyContent: 'space-between', width: '50%', float: 'right' }} >
                                                                                <Typography style={{ fontWeight: '600' }} >T. Students</Typography>
                                                                                <Typography style={{ fontWeight: '600' }} >St. Below Threshold</Typography>
                                                                                <Typography style={{ fontWeight: '600' }}>Avg Marks</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '25%' }}></Typography>
                                                                            </div>
                                                                            <div className='firstSec'  >
                                                                                <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', border: '1px solid #EEEEEE', padding: '1% 2%' }} >
                                                                            ...
                                                                            {cwSection?.result?.length > 0 && cwSection?.result?.map((item) => (

                                                                                <div className='firstSec' onClick={() => handleCwClick(item, each)} >
                                                                                    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', border: '1px solid #EEEEEE', padding: '1% 2%' }} >
                                                                                        <div>
                                                                                            {item?.section_name}
                                                                                        </div>
                                                                        ...
                                                                        <TabPanel value={value} index={3} dir={theme.direction} className="tabPaneltest">
                                                                            <div style={{ display: 'flex', justifyContent: 'space-between', width: '50%', float: 'right' }} >
                                                                                <Typography style={{ fontWeight: '600' }} >T. Students</Typography>
                                                                                <Typography style={{ fontWeight: '600' }} >St. Below Threshold</Typography>
                                                                                <Typography style={{ fontWeight: '600' }}>Avg Marks</Typography>
                                                                                <Typography style={{ fontWeight: '600', width: '30%' }}></Typography>
                                                                            </div>
                                                                            <div className='firstSec' >
                                                                            {allCp && allCp.map((item, index) => (
                                                                                    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', border: '1px solid #EEEEEE', padding: '1% 2%' }}  >
                                                                                        <div>
                                                                                            All Section
                                                                                        </div>
                                                                                ...
                                                                                {cpSection && cpSection.map((item, index) => (
                                                                                    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', border: '1px solid #EEEEEE', padding: '1% 2%' }} onClick={() => handleCpClick(item, each)} >
                                                                                        <div>
                                                                                            {item?.section_name}
                                                                                        </div>
                                                                                        <div style={{ display: 'flex', justifyContent: 'space-between', width: '45%', marginRight: '3%' }} >
