...
import { Grid, TextField, Button, useTheme, SvgIcon, IconButton, TextareaAutosize  } from '@material-ui/core';
...
const  CraeteCircular=()=> {
    ...
    const circularRole=[
        ...
        {name:editData.module_name ==='Student Circular'?'Teacher Circular': null || 'Teacher Circular',value:'Teacher Circular'}
    ]
