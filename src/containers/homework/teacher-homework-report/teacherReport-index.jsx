...
import ViewHomeworkSubmission from '../teacher-homework/view-homework-submission';
...
const TeacherHomeworkReport = withRouter(
  ({
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherHomeworkReport);
