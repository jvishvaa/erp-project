...
const SubmittedQuestionNew = ({
  ...
  useTimeTracker('homework_teacher', { title: selectedHomeworkDetails?.homework_name });
    ...
    >
      <div className='d-flex justify-content-between'>
        <div className='th-13 col-md-8 th-br-10' style={{ background: '#eef2f8' }}>
          <div className='p-4 th-14 th-fw-600'>
        ...
        >
          <p
            className='th-14 th-fw-600 mx-2'
            style={{
      ...
      {/* teacher Attachment */}
      {selectedHomeworkDetails?.hw_questions[activeQuestion - 1]?.question_files?.length >
      0 ? (
        <div className='attachments-container'>
          <div
            className='col-md-8 my-2 p-2 th-14 th-fw-600 th-br-10'
            style={{ background: '#eef2f8', borderBottom: '1px solid grey' }}
          >
            Teacher Attachments
          </div>
