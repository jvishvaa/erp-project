            ...
            <Grid item xs={6}>
              ...
              style={{
                ...
                <CardActions>
                  ...
                  <p style={{ fontSize:'12px',fontFamily: 'Arial', color: 'green', 'margin-left': '1rem','margin-top': '100px' }}>{data[1]&&data[1].status === '5' ? 'Revision' :''}</p>
            ...
            <Grid item xs={6}>
              ...
              >
                ...
                <CardActions >
                  ...
                  <p style={{ fontSize:'12px',fontFamily: 'Arial', color: 'green', 'margin-left': '1rem','margin-top': '100px' }}>{data[2]&&data[2].status === '5' ? 'Revision' :''}</p>
            ...
            <Grid item xs={6}>
              ...
              style={{
                ...
                <CardActions>
                  ...
                  <p style={{ fontSize:'12px',fontFamily: 'Arial', color: 'green', 'margin-left': '1rem','margin-top': '100px' }}>{data[3]&&data[3].status === '5' ? 'Revision' :''}</p>
            ...
            <Grid item xs={6}>
              ...
              style={{
                ...
                <CardActions >
                  ...
                  <p style={{ fontSize:'12px',fontFamily: 'Arial', color: 'green', 'margin-left': '1rem','margin-top': '100px' }}>{data[4]&&data[4].status === '5' ? 'Revision' :''}</p>
