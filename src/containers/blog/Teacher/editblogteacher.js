...
import previewBlogteacher from './previewBlogteacher';
...
class EditBlogTeacher extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // image :'',
  ...
  componentDidMount() {
    ...
    let studentName = this.props?.history?.location?.state?.author;
  ...
  PreviewBlogNav = () => {
    ...
    this.props.history.push({
      pathname: '/blog/teacher/preview-edit-blog',
      state: {
        genreName,
        genreObj,
        studentName,
...
export default withRouter(withStyles(styles)(EditBlogTeacher));
