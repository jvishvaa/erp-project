            ...
            return <Grid item xs={12} sm={6} md={4}>
              <Card className={classes.root} >
                ...
                <CardContent style={{ pagging: '1px' }}>
                  <Typography color = "secondary" className={classes.typoStyle}>Grade Name: {item.grade.grade_name} </Typography>
                  <Typography color = "secondary" className={classes.typoStyle}>Word Count : {item.word_count}</Typography>
                  <Typography color = "secondary" className={classes.typoStyle}>Created By : {item.created_by.first_name}</Typography>
                </CardContent>
              </Card>
            </Grid>
