...
const CreateWordCountConfig = (props) => {
  ...
  const handleDelete = (data) => {
    ...
    axiosInstance
      .put(`${endpoints.blog.WordCountConfig}`, requestData)
  ...
  const handleSubmit = (e) => {
    ...
    if (!chkNumber) {
      ...
      axiosInstance
        .post(`${endpoints.blog.WordCountConfig}`, requestData)
  ...
  const getActiveList = () => {
    axiosInstance
      .get(
        `${endpoints.blog.WordCountConfig}?page_number=${pageNumber}&page_size=${pageSize}`
      )
      .then((res) => {
                    ...
                    <Card className={classes.root}>
                      ...
                      <CardContent style={{ pagging: '1px' }}>
                        <Typography color='secondary' className={classes.typoStyle}>
                          Grade Name: {item.grade.grade_name}{' '}
                        </Typography>
                        <Typography color='secondary' className={classes.typoStyle}>
