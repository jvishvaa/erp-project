...
const QuestionBankDrawer = ({drawerOpen, onClose, section, questionId , grade , erpCategory,questionPaperWise}) => {
...
if(!formik.values.subject && !formik.values.erp_category){
    ...
    if (formik.values.erp_category) {
      requestUrl += `&category=${tabIsErpCentral ? erpCategory?.central_category_id : erpCategory?.erp_category_id}`;
    }
    setLoading(true)
    axiosInstance
      .get(requestUrl)
...
const handleQuestionCategory = (value) => {
    ...
    const fetchchapterData= (params = {}) => {
      ...
      const fetchKeyConceptsData = (value) => {
        ...
        axiosInstance
        .get(`assessment/question_count/?chapter_id=${value?.chapter_id}&is_central=${value?.is_central ? 1 : 0}`, {
  ...
  return (
    ...
    title="Questions from Question Bank"
        ...
        >
          ...
          <div className='row d-flex col-md-12' style={{background:'#ecf4f8',height:'35px'}}>
        ...
        <div className='mx-1 mt-4' style={{border : '2px solid #e9e9e9'}}>
            <div className='row mt-2 th-fw-600 ml-3'>
                Write Question
            </div>
            <div className='filters mt-2 ml-3 py-2'>
                <Form id='filterForm' ref={formRef} layout={'horizontal'}>
              <div className='row align-items-center'>
              {!erpCategory && <div className='col-md-3 col-6 pl-1'>
                ...
                {/* {boardFilterArr.includes(window.location.host) && ( */}
                  {!erpCategory && <div className='col-md-3 col-6 pl-0'>
                ...
                <div className='col-md-3 col-6 pl-1 '>
                ...
                <div className='d-flex col-md-8 col-12 pl-0'>
                  <div className='mb-2 text-left' style={{color:'#2f90b1'}}>Select Question Type</div>
                  <Form.Item name='questiontype' className='ml-3'>
                    <Select
                      allowClear
         ...
         <div className='d-flex justify-content-center align-items-center h-50'>
          ...
          {viewMore && 
          <Drawer
          title= {resolveQuestionTypeName(periodDataForView.question_type) + '  (' + (getquestionLevel(parseInt(periodDataForView?.question_level)))  + ')'}
          placement='right'
