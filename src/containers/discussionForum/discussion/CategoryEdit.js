...
import { Box, Button, makeStyles, withStyles, TextField, FormControlLabel, Switch } from '@material-ui/core';
...
const CategoryEdit = (props) => {
    ...
    const [ subSubCategory, setSubSubCategory] = React.useState(props.cardData.subSubCategory);
    const [ activeCategory, setActiveCategory ] = React.useState(props.cardData.status === 'active'? true : false);
