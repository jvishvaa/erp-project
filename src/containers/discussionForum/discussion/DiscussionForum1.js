...
import { makeStyles, withStyles, Grid, Button, Typography, Tabs, Tab, Paper, Divider } from '@material-ui/core';
                        ...
                        <Grid container className={classes.disscustionContainer}>
                            ...
                            <Grid item xs={12}>
                                ...
                                { categoryData.map((data, id) => {
                                    return (
                                    (tabValue === 'active' && tabValue === data.status && (
                                        <Grid item xs={3} keys={id}>
                                            <CategoryCard
                                                id={data.id}
                                                status={data.status}
                                        ...
                                        )) || (tabValue === 'inactive' && tabValue === data.status && (
                                            <Grid item xs={3} keys={id}>
                                                <CategoryCard
                                                    id={data.id}
                                                    status={data.status}
                                ...
                                <Grid item xs={12} className={classes.pageFooter}>
                                    ...
                                    <span className={classes.pageNumberSpan}>1</span>
                                    <Button
                                    variant="text"
                                    color="primary"
