...
import { Grid, Typography, Select, FormControl, InputLabel, MenuItem, Button } from '@material-ui/core';
      ...
      <Grid container className={classes.root}>
        <Grid item xs={12} className={classes.categoryBox}>
          ...
          <Grid container className={classes.categoryContainer}>
              ...
              <Grid item sm={3}>
                <FormControl variant="outlined" color="primary" className={classes.formControl}>
                  <InputLabel id="demo-simple-select-outlined-label">Sub-sub category</InputLabel>
                  <SelectInput
                    labelId="demo-simple-select-outlined-label"
                    id="demo-simple-select-outlined"
                    value={category}
