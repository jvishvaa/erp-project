...
export default function CategoryFilterComponent() {
  ...
  return (
    <div className={classes.verticalDiv}>
      <Accordion rounded expanded={expanded === 'panel1'} onChange={handleChange('panel1')} className={classes.academicPanel}>
      ...
      <Accordion rounded expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header"
