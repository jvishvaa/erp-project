    ...
    return (
        <Editor
            ...
            init={{
                ...
                menubar: false,
                plugins: [
                    'lists link file image media paste help wordcount'
                ],
                content_style: "body { color: #014b7e; font-size: 14pt; font-family: Arial; }",
                toolbar: 'fontselect fontsizeselect bold italic alignleft aligncenter alignright underline bullist numlist file image media customInsertButton',
