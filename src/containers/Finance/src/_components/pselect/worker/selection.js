...
//       console.log(data.newData.content)
//       root = firstTreeModel.parse(data.newData.content)
//       if (data.newData.selectedItems) {
//         queue.push(() => {
//           root.walk({ strategy: 'pre' }, function (node) {
//             if (data.newData.selectedItems.includes(node.model.id)) {
//               node.model.marked = true
//               selectedItems[node.model.id + '/' + node.model.type] = true
//               selectedItemData[node.model.id + '/' + node.model.type] = { id: node.model.id, db_id: node.model.db_id, type: node.model.type, name: node.model.name, grade: node.parent.model.name, grade_id: node.parent.model.id, branch: node.parent.parent.model.name, branch_id: node.parent.parent.model.id }
//             }
//           })
//           self.postMessage({
//             items: selectedItems,
...
//           let parent
//           root.walk({ strategy: 'pre' }, function (node) {
//             if (node.model.id === data.newData.content.id && node.model.type === data.newData.content.type) {
//               parent = node.parent.model
//               console.log(parent)
//               return false
//             }
//           })
//           console.log(parent)
//           root.walk({ strategy: 'pre' }, function (node) {
//             if (node.model.name === data.newData.content.name && node.parent.model.name === parent.name) {
//               if (data.newData.content.value) {
//                 node.model.marked = true
//                 selectedItems[node.model.id + '/' + node.model.type] = true
//                 selectedItemData[node.model.id + '/' + node.model.type] = { id: node.model.id, db_id: node.model.db_id, type: node.model.type, name: node.model.name, grade: node.parent.model.name, grade_id: node.parent.model.id, branch: node.parent.parent.model.name, branch_id: node.parent.parent.model.id }
//               } else {
//                 node.model.marked = false
//                 delete selectedItems[node.model.id + '/' + node.model.type]
//                 delete selectedItemData[node.model.id + '/' + node.model.type]
//               }
//             }
//           })
//         } else {
...
//           itemData: selectedItemData })
//       })
//     } else if (data.newData.type === 'select_all') {
//       queue.push(() => {
//         root.walk({ strategy: 'pre' }, function (node) {
//           if (data.state.apply_all) {
//             if (node.parent) {
//               if (node.parent.model.name === data.newData.content.name && node.model.type === data.newData.content.type) {
//                 if (data.newData.content.value) {
//                   node.model.marked = true
//                   selectedItems[node.model.id + '/' + node.model.type] = true
//                   selectedItemData[node.model.id + '/' + node.model.type] = { id: node.model.id, db_id: node.model.db_id, type: node.model.type, name: node.model.name, grade: node.parent.model.name, grade_id: node.parent.model.id, branch: node.parent.parent.model.name, branch_id: node.parent.parent.model.id }
...
//           } else {
//             if (node.parent) {
//               if (node.parent.model.id === data.newData.content.id && node.model.type === data.newData.content.type) {
//                 if (data.newData.content.value) {
//                   node.model.marked = true
//                   selectedItems[node.model.id + '/' + node.model.type] = true
//                   selectedItemData[node.model.id + '/' + node.model.type] = { id: node.model.id, db_id: node.model.db_id, type: node.model.type, name: node.model.name, grade: node.parent.model.name, branch: node.parent.parent.model.name, grade_id: node.parent.model.id, branch_id: node.parent.parent.model.id }
//                 } else {
//                   node.model.marked = false
//                   delete selectedItems[node.model.id + '/' + node.model.type]
//                   delete selectedItemData[node.model.id + '/' + node.model.type]
...
//         })
//       })
//     } else if (data.newData.type === 'unselect_all') {
