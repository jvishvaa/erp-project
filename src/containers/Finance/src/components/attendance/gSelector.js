...
export const ROLES = { ADMIN: 'Admin', FOE: 'FOE', BDM: 'BDM', TEACHER: 'Teacher', PRINICIPAL: 'Principal', ACADEMICCOORDINATOR: 'AcademicCoordinator', LEADTEACHER: 'LeadTeacher', CFO: 'CFO', EAACADEMICS: 'EA Academics' }
