...
export const ROLES = { PRINICIPAL: 'Principal', BDM: 'BDM', ADMIN: 'Admin', ACADEMICCOORDINATOR: 'AcademicCoordinator', TEACHER: 'Teacher', LEADTEACHER: 'LeadTeacher', EAACADEMICS: 'EA Academics', FOE: 'FOE'
}
