...
export const ROLES = { ADMIN: 'Admin', TEACHER: 'Teacher', REVIEWER: 'Reviewer', SUBJECTHEAD: 'Subjecthead', PLANNER: 'Planner', STUDENT: 'Student', EXAMINATIONHEAD: 'ExaminationHead' }
