    ...
    attemptModal = (
      ...
      >
        <div style={{ width: '100vw', height: '100vh' }}>
          <iframe id='attempt-iframe' src={`${urls.BASE}/homework_tool/?file_id=${file.id}&hw_submission_id=13`} frameBorder='0' style={{ overflow: 'hidden', height: '100%', width: '100%' }} height='100%' width='100%' />
        </div>
      </MaterialModal>
    )
  }
