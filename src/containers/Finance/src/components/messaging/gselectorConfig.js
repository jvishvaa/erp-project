...
export const ROLES = { ADMIN: 'Admin', PRINICIPAL: 'Principal', ACADEMICCOORDINATOR: 'AcademicCoordinator', MIS: 'MIS', LEADTEACHER: 'LeadTeacher', CFO: 'CFO', EAACADEMICS: 'EA Academics', TEACHER: 'Teacher' }
