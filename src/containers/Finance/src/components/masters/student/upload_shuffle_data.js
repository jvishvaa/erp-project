...
class studentsShuffleUpload extends Component {
  constructor () {
    super()
    this.state = { datafile: [],
      percentCompleted: 0,
  ...
  handleUpload = () => {
    ...
    axios
      .post(urls.StudenShuffleUpload, formData, {
        headers: {
  ...
  onClick () {
    window.location.href = urls.StudentShuffleUpload
  }
          ...
          <Table collapsing celled>
            <Table.Header>
              <Table.Row>
                ...
                <Table.HeaderCell>ERP code</Table.HeaderCell>
                <Table.HeaderCell>Current Grade</Table.HeaderCell>
                <Table.HeaderCell>Current Section</Table.HeaderCell>
                <Table.HeaderCell>Change Grade</Table.HeaderCell>
                <Table.HeaderCell>Change Section</Table.HeaderCell>
              </Table.Row>
            </Table.Header>
          </Table>
        </div>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(studentsShuffleUpload))
