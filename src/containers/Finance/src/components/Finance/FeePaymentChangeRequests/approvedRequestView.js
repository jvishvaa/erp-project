...
const ApprovedRequestView = ({ classes, history, dataLoading, fetchBranchTransaction, branchPendingList, alert, user }) => {
  useEffect(() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(ApprovedRequestView)))
