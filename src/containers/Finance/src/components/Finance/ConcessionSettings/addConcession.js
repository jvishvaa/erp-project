...
class AddConcessionSettings extends Component {
  ...
  handleSubmitConcession = () => {
    let data = {
      ...
      normal_fee_types: this.state.normalFeeId,
      miscellaneous_fee_types: this.state.miscFeeId,
        ...
        <Grid container direction='column' spacing={3} style={{ padding: 15 }}>
          ...
          <Grid item xs='5'>
            ...
            <Select
              ...
              name='normalFee'
              options={
                this.props.listConcessionTypes.normal_fee_types && this.props.listConcessionTypes.normal_fee_types.length
                  ? this.props.listConcessionTypes.normal_fee_types.map(normalFeeType => ({
          ...
          <Grid item xs='5'>
            ...
            <Select
              ...
              name='miscFee'
              options={
                this.props.listConcessionTypes.misc_fee_types && this.props.listConcessionTypes.misc_fee_types.length
          ...
          <Grid item xs='5'>
            ...
            <Select
              ...
              name='otherFee'
              options={
                this.props.listConcessionTypes.other_fee_types && this.props.listConcessionTypes.other_fee_types.length
                  ? this.props.listConcessionTypes.other_fee_types.map(otherFeeType => ({
          ...
          <Grid item xs='5'>
            <label>Minimum amount to be payable for this concession to be availed(only normal fees)*</label>
            <input
              name='amount'
              placeholder='amount'
              style={{ width: '200px' }}
          ...
          <Grid item xs='5'>
            <Button
              ...
              disabled={
                !this.state.concessionTypeId || !this.state.concession_name || !this.state.automatic_manual_fixed ||
                            !this.state.normalFeeId || !this.state.miscFeeId || !this.state.otherFeeId ||
                            !this.state.adjustmentOrder || !this.state.amount
              }
            >
                    Add
            </Button>
...
export default connect(mapStateToProps, mapDispatchToProps)((withRouter(AddConcessionSettings)))
