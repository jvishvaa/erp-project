...
class UpdateAddressDetailsFormAcc extends Component {
  constructor (props) {
    super(props)
    this.state = {
      seesion: null,
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (nextProps.admissionrecordbyerp) {
      ...
      newaddressDetails['perAdd'] = nextProps.admissionrecordbyerp.permanent_address ? nextProps.admissionrecordbyerp.permanent_address : null
      newaddressDetails['perzip'] = nextProps.admissionrecordbyerp.permanent_zipcode ? nextProps.admissionrecordbyerp.permanent_zipcode : null
      this.setState({
          ...
          <Grid container spacing={3}>
            <Grid item xs={3} className={classes.spacing}>
              ...
              <TextField
                ...
                margin='dense'
                fullWidth
                value={this.state.addressDetails.tempzip}
                onChange={this.addressDetailsInputHandler}
                variant='outlined'
                name='tempzip' />
            </Grid>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(withRouter(UpdateAddressDetailsFormAcc)))
