...
const MealAgreement = ({ classes, session, history, dataLoading, fetchBranches, branchPerSession, alert, user }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(MealAgreement)))
