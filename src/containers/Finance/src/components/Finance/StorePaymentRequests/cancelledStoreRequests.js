...
const CancelledStoreRequests = ({ classes, history, dataLoading, fetchStoreBranchTransaction, branchPendingList, alert, user }) => {
  useEffect(() => {
...
CancelledStoreRequests.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(CancelledStoreRequests)))
