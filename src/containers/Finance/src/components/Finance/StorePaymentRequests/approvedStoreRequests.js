...
const ApprovedStoreRequests = ({ classes, history, dataLoading, fetchStoreBranchTransaction, branchPendingList, alert, user }) => {
  useEffect(() => {
...
ApprovedStoreRequests.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(ApprovedStoreRequests)))
