...
const RejectedStoreRequests = ({ classes, history, dataLoading, fetchStoreBranchTransaction, branchPendingList, alert, user }) => {
  useEffect(() => {
...
RejectedStoreRequests.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(RejectedStoreRequests)))
