...
export default class TeacherReportLagging extends Component {
  render () {
    return (
      <div className='student-section'>
        ...
        <Grid>
          <Grid.Column computer={8} mobile={16} tablet={10} floated='left'>
            <label className='student-heading'>Manage</label>&nbsp;&nbsp;&nbsp;Teacher Report Lagging
          </Grid.Column>
          <Grid.Column computer={8} mobile={16} tablet={10} floated='right'>
            ...
            >
              ...
              <Breadcrumb.Section active>Teacher Report Lagging</Breadcrumb.Section>
            </Breadcrumb>
          </Grid.Column>
        </Grid>
        <div className='formargin'>
          <Container>
            <Segment.Group>
              <Segment>
                <Header as='h3' style={{ color: '#4d4d4d' }}>Teacher Report Lagging</Header>
                <Divider />
                <Form >
