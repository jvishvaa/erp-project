import React, {
  ...
  const PendingPhysicalActivity = (props) => {
    ...
    const submitReview = () => {
      ...
      setLoading(true)
      axios
        .post(`${endpoints.newBlog.PendingPhysicalActivity}`, body, {
          headers: {
                        ...
                        >
                          ...
                          >
                            ...
                            {/* <StyledRating
                              name={`rating${index}`}
                              size='small'
                              value={obj?.name == 'Overall' ? calculateOverallRating() : obj?.given_rating}
                              max={obj?.rating}
  ...
  export default PendingPhysicalActivity;
