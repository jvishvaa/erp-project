...
import { Brush, FullscreenRounded, FullscreenExitRounded, GetApp, ArrowBack, ArrowForward } from '@material-ui/icons'
    ...
    <React.Fragment>
      ...
      >
        ...
        <div
          ...
          className='evaluvation_tool_bar'
        >
          <Button
          ...
          <Tooltip title='save' arrow>
            <Button
              ...
              aria-label='close' disabled={isSaved}
              style={{ borderRadius: 'inherit' }}
            >
              {isSaved ? 'SAVING...' : 'SAVE'}
            </Button>
...

        {
          !open
            ...
            : <div className='loading_container' style={{
              ...
              {(loading || isPending || correctionLoading) && <div
                style={{
                  display: 'flex',
