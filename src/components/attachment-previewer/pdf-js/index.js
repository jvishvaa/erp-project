...
export default function PdfjsPreview({ url }) {
  ...
  const PdfViewerCSS = (props) => {
    return <ImportScript link resourceUrl={`${moduleBaseURL}/pdf_viewer.css`} />;
  };
  const ViewerCSS = (props) => {
    return <ImportScript link resourceUrl={`${moduleBaseURL}/viewer.css`} />;
  };
