...
export const moduleBaseURL = 'https://pdfviewerk12.s3.ap-south-1.amazonaws.com'
...
// let pdfjsLib
// let pdfjsViewer
// const ispdfjsLibReady = loadScript(`${moduleBaseURL}/pdf.js`)
...
//     pdfjsLib.GlobalWorkerOptions.workerSrc = `${moduleBaseURL}/pdf.worker.js`;
// })

// export function PDFViewerApplicationWarp(pdfjsLib, pdfjsViewer) {
export function PDFViewerApplicationWarp() {
    ...
    if (!pdfjsLib || !pdfjsViewer) {
        // if (!pdfjsLib.getDocument || pdfjsViewer || !pdfjsViewer.PDFViewer) {
        //     alert("Please build the pdfjs-dist library using\n `gulp dist-install`");
        // } else {
        //     alert("Please build the pdfjs-dist library using\n `gulp dist-install`");
        // }
    ...
    const CMAP_URL = `${moduleBaseURL}cmaps/`;
    ...
    const DEFAULT_URL = "https://d2r9gkgplfhsr2.cloudfront.net/dev/lesson_plan_file/2021-22/Volume 1/Grade 3/English/CS_ Ch 1_Sequencing_Rev/Period-1/Student_Reading_Material/2021-03-23 07:43:40.672606_Grade 3_Vol 1_English_CS_Ch 1_Sequencing_Rev_Pd 14_Student Reading Material.pdf";
