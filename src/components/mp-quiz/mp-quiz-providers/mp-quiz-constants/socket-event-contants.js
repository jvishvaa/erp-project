...
const WebSockectEvents = {
  [fetchParticipants]: {
    eventLabel: fetchParticipants,
    storageKey: `wb_${fetchParticipants}`,
    prevDataStrgKey: `wb_prev_${fetchParticipants}`,
  },
  [fetchLeaderboard]: {
    eventLabel: fetchLeaderboard,
    storageKey: `wb_${fetchLeaderboard}`,
    prevDataStrgKey: `wb_prev_${fetchLeaderboard}`,
  },
  [removeUser]: {
    eventLabel: removeUser,
    storageKey: `wb_${removeUser}`,
    prevDataStrgKey: `wb_prev_${removeUser}`,
  },
  [respondToQuestion]: {
    eventLabel: respondToQuestion,
    storageKey: `wb_${respondToQuestion}`,
    prevDataStrgKey: `wb_prev_${respondToQuestion}`,
  },
  [startQuiz]: {
    eventLabel: startQuiz,
    storageKey: `wb_${startQuiz}`,
    prevDataStrgKey: `wb_prev_${startQuiz}`,
  },
  [endQuiz]: {
    eventLabel: endQuiz,
    storageKey: `wb_${endQuiz}`,
    prevDataStrgKey: `wb_prev_${endQuiz}`,
  },
  [joinLobby]: {
    eventLabel: joinLobby,
    storageKey: `wb_${joinLobby}`,
    prevDataStrgKey: `wb_prev_${joinLobby}`,
  },
  [null]: {
    eventLabel: 'null',
    storageKey: `wb_${null}`,
    prevDataStrgKey: `wb_prev_${null}`,
  },
  [undefined]: {
    eventLabel: 'undefined',
    storageKey: `wb_${undefined}`,
    prevDataStrgKey: `wb_prev_${undefined}`,
  },
};
