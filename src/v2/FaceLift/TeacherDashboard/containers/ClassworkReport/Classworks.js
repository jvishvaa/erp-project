...
const Classworks = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: '5%',
      render: () => (
        <span onClick={() => history.push('./studentwise-classwork-report')}>
      ...
      <div className='row py-3 px-2'>
        <div className='col-md-8'>
          <Breadcrumb separator='>'>
            ...
            <Breadcrumb.Item className='th-black-1 th-16'>Classworks</Breadcrumb.Item>
          </Breadcrumb>
        </div>
