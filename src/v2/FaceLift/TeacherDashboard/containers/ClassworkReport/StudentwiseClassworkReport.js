...
const StudentwiseClassworkReport = () => {
  const columns = [
    {
      ...
      <div className='row th-16 py-3 px-2'>
        <div className='col-12'>
          <Breadcrumb separator='>'>
            ...
            <Breadcrumb.Item
              href='/subjectwise-classwork-report'
              className='th-grey th-16'
            >
              Subjectwise Report
            </Breadcrumb.Item>
            <Breadcrumb.Item href='/titlewise-classwork-report' className='th-grey th-16'>
              Classworks
            </Breadcrumb.Item>
        ...
        <div className='col-12 '>
          <div className='row th-13 mt-3 pt-2 th-bg-white th-br-4 align-items-center text-left th-fw-500 th-grey'>
            ...
            <div className='col-md-2 col-6 th-custom-col-padding pb-2'>
              Classwork: <span className='th-primary'>Title</span>
            </div>
            <div className='col-md-2 col-6 th-custom-col-padding pb-2'>
...
export default StudentwiseClassworkReport;
