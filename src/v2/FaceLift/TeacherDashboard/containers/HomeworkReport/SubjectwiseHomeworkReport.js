...
const subjectwiseHomeworkReport = [
  {
    subject: 'Mathematics',
    assigned: 100,
    submitted: 90,
...
const SubjectwiseHomeworkReport = () => {
  ...
  const columns = [
    ...
    {
      title: <span className='th-white th-fw-700'>HOMEWORKS ASSIGNED</span>,
      dataIndex: 'assigned',
      align: 'center',
    ...
    },
    {
      ...
      render: () => (
        <span
          className='pr-4'
          onClick={() => history.push('./titlewise-homework-report')}
        >
        ...
        <div className='row mt-2'>
          <div className='col-12'>
            <Table
              ...
              dataSource={subjectwiseHomeworkReport}
              pagination={false}
...
export default SubjectwiseHomeworkReport;
