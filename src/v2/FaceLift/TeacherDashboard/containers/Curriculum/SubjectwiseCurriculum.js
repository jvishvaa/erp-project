...
const subjectwiseCurriculumReport = [
  {
    subject: 'Mathematics',
    total: 50,
    completed: 35,
...
const SubjectwiseCurriculumReport = () => {
  ...
  const columns = [
    ...
    {
      title: <span className='th-white th-fw-700'>TOTAL TOPICS</span>,
      dataIndex: 'total',
      align: 'center',
      render: (data) => <span className='th-black-1'>{data}</span>,
    },
    {
      title: <span className='th-white th-fw-700'>COMPLETED TOPICS</span>,
      dataIndex: 'completed',
      align: 'center',
      render: (data) => <span className='th-black-1'>{data}</span>,
    },
    ...
    },
    {
      ...
      render: () => (
        <span
          className='pr-4'
          onClick={() => history.push('./chapterwise-curriculum-report')}
        >
        ...
        <div className='row mt-2'>
          <div className='col-12'>
            <Table
              ...
              dataSource={subjectwiseCurriculumReport}
              pagination={false}
...
export default SubjectwiseCurriculumReport;
