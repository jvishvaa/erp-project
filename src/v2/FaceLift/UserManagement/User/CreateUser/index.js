...
const CreateUser = () => {
    ...
    axiosInstance
      ...
      .then((response) => {
        ...
        var schoolDetails = {
          ...
          device_expiry: transformedSchoolDetails?.device_expiry ? moment(transformedSchoolDetails?.device_expiry) : '',
  ...
  const handleSubmit = (formValues) => {
    ...
    formData.append(
      'device_expiry',
      moment(schoolFormValues?.device_expiry).format('YYYY-MM-DD') ?? ''
    );
