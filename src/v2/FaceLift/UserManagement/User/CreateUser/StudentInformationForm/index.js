...
const StudentInformation = ({
  ...
  useEffect(() => {
    console.log(guardian, 'oiuyyyyyui');
        ...
        >
          <Row gutter={24}>
            <Col className='py-2' md={24}>
              <Form.Item required label='Student Image'>
                <div className='d-flex align-items-end'>
                  ...
                  <div className='pl-3'>
                    <div className='pb-1'>{photo ? photo?.name : 'No file uploaded'}</div>
                    <label htmlFor='profile' className='ant-btn ant-btn-primary'>
                      Upload Image
                    </label>
                    <input
                      id='profile'
            ...
            <Col className='py-2' md={12}>
              <div>
                ...
                <div className='d-flex th-padding-card align-items-center'>
                  ...
                  <Form.Item style={{ margin: '0px' }} name={'single'}>
                    <Radio.Group
